...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if (!empty($starting_location) && !empty($ending_location) && !empty($km_traveled) && !empty($date_traveled)) {
        ...
        $query = "insert into `mileage_allowance` (id, name, surname, starting_location, ending_location, km_traveled, date_traveled) values ('$user_id','$name','$surname','$starting_location','$ending_location','$km_traveled','$date_traveled')";
